...
`,Hi=o.div`
  ...
  margin-top: 10px;
  width: 100%;
`;function Bi({}){const{img:a,title:e,stadium:t,date:n,homename:r,awayname:s,meetingPlace:d,detailMeetingPlace:l,term:c,minNum:h,maxNum:u,content:w,tag:C}=D(S=>S.summary),y=D(S=>S.selecteditem);return b(Ai,{children:[i(Oi,{children:i(Wi,{src:a,alt:"선택한 배경 사진이 없습니다.(No Image)"})}),i(Li,{children:e}),b(X,{children:[i(Z,{children:"🔥 매치 정보"}),i($i,{children:b(De,{children:[b(Me,{children:[i(ae,{children:i(Ee,{children:n})}),i(ae,{children:b(Ee,{children:[t," 경기장"]})})]}),i(Te,{children:b(W,{children:[" ",r&&s?r+" vs "+s:""," "]})})]})})]}),b(X,{children:[i(Z,{children:"🔥 동행 정보"}),i(Gi,{children:h&&u&&d&&l&&c?b(De,{children:[i(Me,{children:b(ae,{children:[i(W,{children:"희망 인원 "}),b(W,{children:[" ",h," ~ ",u," 명"]})]})}),b(Te,{children:[b(W,{children:[" ","동행 장소 ",d," ",l]}),b(W,{children:[" 동행 기간 ",c," "]})]})]}):i(Q,{})})]}),b(X,{children:[i(Z,{children:"🔥 태그 정보"}),i(Vi,{children:C.map((S,v)=>i(qi,{children:S.origName},v))})]}),b(X,{children:[i(Z,{children:"🔥 카드 정보"}),i(Ki,{children:i(Xi,{children:b(Yi,{children:[y.house.length>0&&i(J,{index:0,ischk:!1}),y.food.length>0&&i(J,{index:1,ischk:!1}),y.attraction.length>0&&i(J,{index:2,ischk:!1})]})})})]}),i(Ui,{children:w})]})}const Ai=o.div`
  margin: 0 auto;
  width: 80%;
  display: flex;
  flex-direction: column;
...
`,Zi=({title:a,index:e})=>{const t=z();return b(Ji,{children:[i(Qi,{children:a}),b(es,{children:[i(ts,{index:e,onClick:()=>{e===0?t(ie({modalType:"HouseSearchModal",isOpen:!0})):e===1?t(ie({modalType:"FoodSearchModal",isOpen:!0})):e===2&&t(ie({modalType:"AttractionSearchModal",isOpen:!0}))},children:i(ns,{})}),i(J,{index:e,ischk:!0})]})]})},Ji=o.div`
  width:100%;
  padding: 10px;
`,Qi=o.p`
  font-size: 15px;
...
`,ns=o(Pe)`
  ...
  height: 40px;
  color: white;
`,is=["🏠 숙박","🍚 음식점","🏖️ 관광지"],ss=()=>i(as,{children:is.map((a,e)=>i(Zi,{title:a,index:e},e))}),as=o.div`
  width: 100%;
  align-items: center;
  justify-content: center;
  overflow: hidden;
