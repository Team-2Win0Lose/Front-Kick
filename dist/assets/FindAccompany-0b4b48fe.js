...
`,H=t.p`
  font-size: 12px;
`;K("token");const we=n=>{W(r=>r.auth);const[l,p]=a.useState(),u=O(),{search:k}=Y(),v=a.useRef(null),[L,S]=a.useState(),[C,g]=a.useState(!1),[h,j]=a.useState(Number),[f,z]=a.useState([]),[I,F]=a.useState([]),U=r=>{const o=f.includes(r);z(o?f.filter(s=>s!==r):[...f,r])},$=(r,o,s)=>{const d=I.findIndex(c=>c.content===o);F(d!==-1?c=>c.filter((x,q)=>q!==d):c=>[...c,{id:r,content:o,sort_type:s}])};ke(v,()=>g(!1));const E=a.useCallback(async()=>{if(I.length===0){const o=await(await fetch(`${A}/api/recruitments-list/`,{method:"GET"})).json();p(o)}else{const o=await(await fetch(`${A}/api/recruitments-list/${k}`,{method:"GET"})).json();p(o)}},[k]);a.useEffect(()=>{E()},[E]);const N=()=>{const r=I.map(({id:o,sort_type:s})=>{if(s==="home_team")return`${s}_id=${o+1}`;if(s==="recruit")return`now_status=${L}`}).filter(o=>o!==void 0).map((o,s)=>s===0?o:"&"+o).join("");u(`?${r}`)};return i(ve,{children:[e(Ce,{ref:v,children:ye.map(({sort_type:r,title:o,contents:s},d)=>{if(r==="home_team")return i(D,{children:[e(G,{className:h===d?"show":"hide",onClick:()=>{j(d),g(!0)},children:o}),i(Le,{className:h===d&&C?"show":"hide",children:[s.map((c,x)=>e(Ie,{onClick:()=>$(x,c[1],r),children:e(Te,{isSelected:f.includes(c[1]),onClick:()=>U(c[1]),children:e(ze,{src:c[0],alt:"팀로고"})})},x)),e(M,{children:e(V,{onClick:()=>{N(),g(!1)},children:"필터 적용"})})]})]},d);if(r==="recruit")return i(D,{children:[e(G,{className:h===d?"show":"hide",onClick:()=>{j(d),g(!0)},children:o}),i(je,{className:h===d&&C?"show":"hide",children:[s.map((c,x)=>e(Se,{onClick:()=>{S(parseInt(c[1])),$(x,c[1],r)},children:i(_e,{children:[e("input",{type:"radio",name:"recruits"}),c[0]]})},x)),e(M,{children:e(V,{onClick:()=>{N(),g(!1)},children:"필터 적용"})})]})]},d)})}),e(Fe,{children:l==null?void 0:l.map((r,o)=>e("div",{onClick:()=>u(`/findaccompany/detail/${r.recruitmentBoardId}`),children:e(te,{post:r})},o))})]})},ye=[{sort_type:"home_team",title:"구단별",contents:[["https://kickstorage.blob.core.windows.net/logo/gangwon_fc.svg","강원FC"],["https://kickstorage.blob.core.windows.net/logo/gwangju_fc.svg","광주FC"],["https://kickstorage.blob.core.windows.net/logo/daegu_fc.svg","대구FC"],["https://kickstorage.blob.core.windows.net/logo/daejun_hana_citizen.svg","대전하나시티즌"],["https://kickstorage.blob.core.windows.net/logo/suwon_samsung_bluewings.svg","수원삼성블루윙즈"],["https://kickstorage.blob.core.windows.net/logo/fc_seoul.svg","FC서울"],["https://kickstorage.blob.core.windows.net/logo/pohang_stealus.svg","포항스틸러스"],["https://kickstorage.blob.core.windows.net/logo/jeju_united.svg","제주유나이티드"],["https://kickstorage.blob.core.windows.net/logo/incheon_united.svg","인천유나이티드"],["https://kickstorage.blob.core.windows.net/logo/ulsan_hyundai.svg","울산현대"],["https://kickstorage.blob.core.windows.net/logo/suwon_fc.svg","수원FC"],["https://kickstorage.blob.core.windows.net/logo/jeonbuk_hyundai_motors.svg","전북현대모터스"]]},{sort_type:"recruit",title:"모집 여부",contents:[["모집중","0"],["모집종료","1"],["모집완료","2"]]}],ke=(n,l)=>{a.useEffect(()=>{const p=u=>{!n.current||n.current.contains(u.target)||l(u)};return document.addEventListener("mousedown",p),()=>{document.removeEventListener("mousedown",p)}},[n,l])},ve=t.div`
  width: 100%;
  margin-top: 30px;
  margin-bottom: 30px;
  display: flex;
