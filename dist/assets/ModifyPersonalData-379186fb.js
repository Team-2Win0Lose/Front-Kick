import{s as e,e as r,m as h,k as g,j as i,a as t,a4 as l,a5 as p,O as a}from"./vendor-cdd8924f.js";import{O as u}from"./shared/ModifyPersonalData/Onboarding-d7f1380d.js";import"./react-slick-b06b373c.js";/* empty css                       */import"./common-06e38f36.js";const m=n=>{const[o,s]=r.useState(!1),d=()=>{s(!o)},f=h(),c=g(x=>x.auth.isAuthenticated);return r.useEffect(()=>{c||f("/")},[c]),i(y,{children:[i(b,{children:[t(w,{children:"계정 설정"}),t(v,{onClick:d,children:o?t(l,{size:"30"}):t(p,{size:"30"})})]}),o?i(j,{children:[i(z,{children:[t(B,{src:"",alt:"사용자 프로필 이미지"}),t(k,{children:"프로필 이미지 변경"})]}),i(O,{children:[t($,{children:"닉네임"}),t(C,{placeholder:"닉네임"})]}),t(A,{children:"저장하기"})]}):t(a,{})]})},y=e.div`
  width: 100%;
