...
`,ci=i=>s("div",{}),gi=i=>{const e=I(),{minNum:t,maxNum:n,term:o}=T(u=>u.summary),[a,l]=_.useState(new Date),[d,h]=_.useState(null),m=u=>{if(u){const[S,k]=u;l(S),h(k)}};return _.useEffect(()=>{if(a&&d){const u=a.toLocaleDateString("ko-KR"),S=d.toLocaleDateString("ko-KR"),k=`${u} ~ ${S}`;e(re({term:k,minNum:t,maxNum:n}))}},[a,d]),v("div",{children:[s(pi,{children:a&&d||o?o?s(oe,{children:s(K,{children:o})}):v(oe,{children:[s(K,{children:a==null?void 0:a.toLocaleDateString("ko-KR")}),s(K,{children:" ~ "}),s(K,{children:d==null?void 0:d.toLocaleDateString("ko-KR")})]}):s("div",{children:"날짜를 선택해주세요."})}),s(hi,{locale:qe,dateFormat:"yyyy년 MM월 dd일",dateFormatCalendar:"yyyy년 MM월",minDate:new Date,placeholderText:"날짜를 선택해주세요.",selected:a,onChange:m,startDate:a,endDate:d,selectsRange:!0,inline:!0})]})},hi=r(Ue)`
  width: 350px; 
  height: 40px;
  font-size: 12px;
  border-radius: 10px;
...
`,Fi=r.div`
  ...
  ${C.lessThan("mobile")`
		width:100%;
	`}
`;function Hi({}){const{img:i,title:e,stadium:t,date:n,homename:o,awayname:a,meetingPlace:l,detailMeetingPlace:d,term:h,minNum:m,maxNum:u,content:S,tag:k}=T(b=>b.summary),y=T(b=>b.selecteditem),R=T(b=>b.selecteditem.house),w=T(b=>b.selecteditem.food),E=T(b=>b.selecteditem.attraction);return v(Bi,{children:[s($i,{children:e}),v(Y,{children:[s(Z,{children:"🔥 매치 정보"}),s(Oi,{children:v(De,{children:[v(Me,{children:[s(se,{children:s(_e,{children:n})}),s(se,{children:v(_e,{children:[t," 경기장"]})})]}),s(ze,{children:v(A,{children:[" ",o&&a?o+" vs "+a:""," "]})})]})})]}),v(Y,{children:[s(Z,{children:"🔥 동행 정보"}),s(Ai,{children:m&&u&&l&&d&&h?v(De,{children:[s(Me,{children:v(se,{children:[s(A,{children:"희망 인원 "}),v(A,{children:[" ",m," ~ ",u," 명"]})]})}),v(ze,{children:[v(A,{children:[" ","동행 장소 ",l," ",d]}),v(A,{children:[" 동행 기간 ",h," "]})]})]}):s(oe,{})})]}),v(Y,{children:[s(Z,{children:"🔥 태그 정보"}),s(Wi,{children:k.map((b,g)=>s(Li,{children:b.origName},g))})]}),v(Y,{children:[s(Z,{children:"🔥 카드 정보"}),s(Vi,{children:s(qi,{children:v(Ui,{children:[y.house.length>0&&s(J,{index:0,ischk:!1,list:R}),y.food.length>0&&s(J,{index:1,ischk:!1,list:w}),y.attraction.length>0&&s(J,{index:2,ischk:!1,list:E})]})})})]}),s(Gi,{children:S})]})}const Bi=r.div`
  margin: 0 auto;
  width: 80%;
  display: flex;
  flex-direction: column;
