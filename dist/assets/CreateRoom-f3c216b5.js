...
`,mn=o.img`
  ...
  ${_.lessThan("mobile")`
    ...
    height: 40px;
	`}
`,xn=[{item:"https://kickstorage.blob.core.windows.net/logo/gangwon_fc.png",home_team_name:"강원",name:"강원FC"},{item:"https://kickstorage.blob.core.windows.net/logo/gwangju_fc.png",home_team_name:"광주",name:"광주FC"},{item:"https://kickstorage.blob.core.windows.net/logo/daegu_fc.png",home_team_name:"대구",name:"대구FC"},{item:"https://kickstorage.blob.core.windows.net/logo/daejun_hana_citizen.png",home_team_name:"대전",name:"대전하나시티즌"},{item:"https://kickstorage.blob.core.windows.net/logo/suwon_samsung_bluewings.png",home_team_name:"수원",name:"수원삼성블루윙즈"},{item:"https://kickstorage.blob.core.windows.net/logo/suwon_fc.png",home_team_name:"수원FC",name:"수원FC"},{item:"https://kickstorage.blob.core.windows.net/logo/ulsan_hyundai.png",home_team_name:"울산",name:"울산현대"},{item:"https://kickstorage.blob.core.windows.net/logo/incheon_united.png",home_team_name:"인천",name:"인천유나이티드"},{item:"https://kickstorage.blob.core.windows.net/logo/jeonbuk_hyundai_motors.png",home_team_name:"전북",name:"전북현대모터스"},{item:"https://kickstorage.blob.core.windows.net/logo/jeju_united.png",home_team_name:"제주",name:"제주유나이티드"},{item:"https://kickstorage.blob.core.windows.net/logo/pohang_stealus.png",home_team_name:"포항",name:"포항스틸러스"},{item:"https://kickstorage.blob.core.windows.net/logo/fc_seoul.png",home_team_name:"서울",name:"FC서울"}],yn=()=>{const a={dots:!1,autoplay:!1,infinite:!0,slidesToShow:7,slidesToScroll:2,swipeToSlide:!0,accessibility:!0,autoplaySpeed:3e3,speed:500,prevArrow:i(Tn,{children:"‹"}),nextArrow:i(In,{children:"›"})},[e,t]=R.useState([]),[n,r]=R.useState("강원FC"),s=l=>{r(l)},d=R.useCallback(async l=>{const h=await(await fetch(`https://kick-back.azurewebsites.net/api/game_schedule/?home_team_name=${l}`,{method:"GET"})).json();t(h)},[]);return b(wn,{children:[i(bn,{...a,children:xn.map((l,c)=>i(vn,{onClick:()=>{s(l.home_team_name),d(l.home_team_name)},isSelected:n===l.home_team_name,children:b(Sn,{children:[i(kn,{children:i(Dn,{children:i(Rn,{src:l.item,alt:"정보가 없습니다."})})}),i(Mn,{children:i(En,{children:l.name})})]},c)},c))}),n&&i(Cn,{children:i(hn,{teamName:n,teamEvents:e})})]})},bn=o(Ke)`
  .slick-slide {
  }
...
`,zn=o.div`
  ...
  background-color: #1F1F45;
  overflow-x: hidden;
`,{kakao:I}=window,Nn=a=>{let e=[];const t=z(),{detailMeetingPlace:n,meetingPlace:r}=D(s=>s.summary);return R.useEffect(()=>{const s=document.getElementById("map"),d={center:new I.maps.LatLng(37.566826,126.9786567),level:3},l=new I.maps.Map(s,d),c=new I.maps.services.Places,h=new I.maps.InfoWindow({zIndex:1});u();function u(){let f=a.searchKeyword;if(!f.replace(/^\s+|\s+$/g,""))return console.log("키워드를 입력해주세요!"),!1;c.keywordSearch(f,w)}function w(f,m,E){if(m===I.maps.services.Status.OK)C(f),g(E);else if(m===I.maps.services.Status.ZERO_RESULT){alert("검색 결과가 존재하지 않습니다.");return}else if(m===I.maps.services.Status.ERROR){alert("검색 결과 중 오류가 발생했습니다.");return}}function C(f){const m=document.getElementById("places-list"),E=document.getElementById("search-result"),M=document.createDocumentFragment(),T=new I.maps.LatLngBounds;m&&p(m),v();for(var P=0;P<f.length;P++){let V=new I.maps.LatLng(f[P].y,f[P].x),O=S(V,P),te=y(P,f[P]);T.extend(V),function(U,de){I.maps.event.addListener(U,"mouseover",function(){k(U,de)}),I.maps.event.addListener(U,"mouseout",function(){h.close()}),te.onmouseover=function(){k(U,de)},te.onmouseout=function(){h.close()}}(O,f[P].place_name),M.appendChild(te)}m&&m.appendChild(M),E&&(E.scrollTop=0),l.setBounds(T)}function y(f,m){const E=document.createElement("li");let M=`
    ...
    `;E.innerHTML=M,E.className="item",E.onclick=function(){var P;(P=a.handleSearchLocation)==null||P.call(a,m.place_name,m.address_name)};const T=E.querySelector(".checkbox-input");return T==null||T.addEventListener("click",()=>{t(_e({meetingPlace:m.place_name,detailMeetingPlace:n,meetingPlaceAddress:m.address_name})),E.classList.toggle("checked")}),E}function S(f,m,E){var M="https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png",T=new I.maps.Size(36,37),P={spriteSize:new I.maps.Size(36,691),spriteOrigin:new I.maps.Point(0,m*46+10),offset:new I.maps.Point(13,37)},V=new I.maps.MarkerImage(M,T,P),O=new I.maps.Marker({position:f,image:V});return O.setMap(l),e.push(O),O}function v(){for(var f=0;f<e.length;f++)e[f].setMap(null);e=[]}function g(f){const m=document.getElementById("pagination");let E=document.createDocumentFragment(),M;for(;m.hasChildNodes();)m.lastChild&&m.removeChild(m.lastChild);for(M=1;M<=f.last;M++){const T=document.createElement("div");T.href="#",T.innerHTML=M.toString(),M===f.current?T.className="on":T.onclick=function(P){return function(){f.gotoPage(P)}}(M),E.appendChild(T)}m.appendChild(E)}function k(f,m){const E='<div style="padding:10px; z-index:1;" class="marker-title">'+m+"</div>";h.setContent(E),h.open(l,f)}function p(f){for(;f.hasChildNodes();)f.lastChild&&f.removeChild(f.lastChild)}},[a.searchKeyword,n]),i(_n,{children:b(jn,{children:[i(Fn,{id:"map",className:"map"}),b(Bn,{id:"search-result",children:[i(Hn,{children:b(On,{children:[a.searchKeyword," 관련 검색결과"]})}),i(An,{children:i(Wn,{id:"places-list"})}),i(Ln,{id:"pagination"})]})]})})},_n=o.div`
  align-items: center;
  justify-content: center;
`,jn=o.div`
  display: flex;
...
`,ni=o.p`
  font-size: 14px;
  font-weight: 400;
`,ii=a=>{const e=z(),{term:t,minNum:n,maxNum:r}=D(h=>h.summary),[s,d]=R.useState(),[l,c]=R.useState();return b(si,{children:[i(A,{children:"최소"}),i(Re,{children:i("input",{type:"number",value:s||n,onChange:h=>{d(Number(h.target.value)||n),e(oe({term:t,minNum:Number(h.target.value)||n,maxNum:l||r}))}})}),i(A,{children:"명"}),i(A,{children:"-"}),i(A,{children:"최대"}),i(Re,{children:i("input",{type:"number",value:l||r,onChange:h=>{c(Number(h.target.value)||r),e(oe({term:t,minNum:s||n,maxNum:Number(h.target.value)||r}))}})}),i(A,{children:"명"})]})},si=o.div`
  margin: 0 auto;
  display: flex;
  justify-content: center;
  align-items: center;
...
`,ji=a=>i(Fi,{children:b(Bi,{children:[i(gi,{}),i(xi,{}),i(bi,{}),i(Si,{})]})}),Fi=o.div`
  margin: 0 auto;
  width: 80%;
  display: flex;
  flex-direction: column;
...
`,Bi=o.div`
  ...
  margin-top: 10px;
  width: 100%;
`;function Hi({}){const{img:a,title:e,stadium:t,date:n,homename:r,awayname:s,meetingPlace:d,detailMeetingPlace:l,term:c,minNum:h,maxNum:u,content:w,tag:C}=D(S=>S.summary),y=D(S=>S.selecteditem);return b(Oi,{children:[i(Ai,{children:i(Wi,{src:a,alt:"선택한 배경 사진이 없습니다.(No Image)"})}),i(Li,{children:e}),b(Z,{children:[i(X,{children:"🔥 매치 정보"}),i($i,{children:b(De,{children:[b(Me,{children:[i(ae,{children:i(Ee,{children:n})}),i(ae,{children:b(Ee,{children:[t," 경기장"]})})]}),i(Te,{children:b(W,{children:[" ",r&&s?r+" vs "+s:""," "]})})]})})]}),b(Z,{children:[i(X,{children:"🔥 동행 정보"}),i(Gi,{children:h&&u&&d&&l&&c?b(De,{children:[i(Me,{children:b(ae,{children:[i(W,{children:"희망 인원 "}),b(W,{children:[" ",h," ~ ",u," 명"]})]})}),b(Te,{children:[b(W,{children:[" ","동행 장소 ",d," ",l]}),b(W,{children:[" 동행 기간 ",c," "]})]})]}):i(Q,{})})]}),b(Z,{children:[i(X,{children:"🔥 태그 정보"}),i(Vi,{children:C.map((S,v)=>i(Ui,{children:S.origName},v))})]}),b(Z,{children:[i(X,{children:"🔥 카드 정보"}),i(Ki,{children:i(Zi,{children:b(Yi,{children:[y.house.length>0&&i(J,{index:0,ischk:!1}),y.food.length>0&&i(J,{index:1,ischk:!1}),y.attraction.length>0&&i(J,{index:2,ischk:!1})]})})})]}),i(qi,{children:w})]})}const Oi=o.div`
  margin: 0 auto;
  width: 80%;
  display: flex;
  flex-direction: column;
