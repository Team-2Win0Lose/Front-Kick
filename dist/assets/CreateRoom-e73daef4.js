...
`,ni=o.p`
  font-size: 14px;
  font-weight: 400;
`,ii=a=>{const e=z(),{term:t,minNum:n,maxNum:r}=E(p=>p.summary),[i,c]=R.useState(),[d,g]=R.useState();return y(si,{children:[s(A,{children:"최소"}),s(Re,{children:s("input",{type:"number",value:i||n,onChange:p=>{c(Number(p.target.value)||n),e(oe({term:t,minNum:Number(p.target.value)||n,maxNum:d||r}))}})}),s(A,{children:"명"}),s(A,{children:"-"}),s(A,{children:"최대"}),s(Re,{children:s("input",{type:"number",value:d||r,onChange:p=>{g(Number(p.target.value)||r),e(oe({term:t,minNum:i||n,maxNum:Number(p.target.value)||r}))}})}),s(A,{children:"명"})]})},si=o.div`
  margin: 0 auto;
  display: flex;
  justify-content: center;
  align-items: center;
...
`,ui=o.img`
  ...
  border-radius: 10px;
  object-fit: cover;
`,xi=a=>{const e=z(),{img:t,content:n,tag:r,title:i}=E(g=>g.summary);let[c,d]=R.useState("");return s(yi,{children:s("input",{type:"text",id:"title",value:c||i,placeholder:"제목을 입력해주세요.",onChange:g=>{d(g.target.value),e(G({img:t,title:g.target.value,content:n,tag:r}))}})})},yi=o.div`
  flex-shrink: 0;
  background: #fff;
  margin: 0 auto;
  display: flex;
...
`,bi=a=>{const e=z(),{title:t,img:n,tag:r,content:i}=E(g=>g.summary);let[c,d]=R.useState("");return s(wi,{children:s(vi,{value:c||i,onChange:g=>{d(g.target.value),e(G({img:n,title:t,content:g.target.value,tag:r}))},placeholder:"내용을 입력해주세요."})})},vi=o.textarea`
  flex-shrink: 0;
  width: 300px;
  height: 300px;
  padding: 10px;
...
`,Xi=({title:a,index:e})=>{const t=z();return y(Ji,{children:[s(Qi,{children:a}),y(es,{children:[s(ts,{index:e,onClick:()=>{e===0?t(ie({modalType:"HouseSearchModal",isOpen:!0})):e===1?t(ie({modalType:"FoodSearchModal",isOpen:!0})):e===2&&t(ie({modalType:"AttractionSearchModal",isOpen:!0}))},children:s(ns,{})}),s(J,{index:e,ischk:!0})]})]})},Ji=o.div`
  width:100%;
  padding: 10px;
`,Qi=o.p`
  font-size: 15px;
