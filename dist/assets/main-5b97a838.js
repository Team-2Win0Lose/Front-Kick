...
`,q=t.div`
  ...
  cursor: pointer;
  font-size: 24px;
`,H=z("token"),J={Authorization:`Bearer ${H}`},ge=a=>{const[o,c]=d.useState([]),{token:l,isAuthenticated:f}=T(n=>n.auth);d.useEffect(()=>{async function n(){try{const v=await(await fetch(`${j}/api/my-recruitment`,{method:"get",headers:J})).json();c(v)}catch(x){console.error("Error:",x)}}n()},[l]);const r=k();return s("div",{children:[f?s(K,{children:[s(L,{children:["👋 현재 나의 동행일정 (",o==null?void 0:o.length,")"]}),(o==null?void 0:o.length)===0?e(te,{children:e(ee,{children:"예정 중인 동행이 없어요 🥲"})}):e(Q,{children:o.length>0&&(o==null?void 0:o.map((n,x)=>e("div",{onClick:()=>r(`/findaccompany/detail/${n.recruitmentBoardId}`),children:e(S,{post:n})},n.recruitmentBoardId)))})]}):e($,{}),e(X,{children:e(_,{})}),s(W,{children:[e(ne,{children:"🏆 구단별 응원순위"}),e(re,{children:"구단별 모집이 완료된 동행팀 수"}),e(A,{})]}),s(Z,{children:[e(ie,{children:"🙋‍♂️ 동행 구경하기"}),e(oe,{children:"나의 동행을 찾아보세요!"}),e(C,{})]})]})},K=t.div`
  width: 100%;
  margin-bottom: 30px;
  display: flex;
  flex-direction: column;
